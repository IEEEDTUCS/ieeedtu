      ...
      <div className='modal'>
        <div className='modal-list'>
          <div className='modal-text'>
            ...
            <a href='https://docs.google.com/forms/d/e/1FAIpQLSfqmxv8OrP1wmhgNrUtnZSMKzlLI8WmtxibAGmVqqd8YHjgJQ/viewform' rel="noreferrer" target='_blank' className='join-btn'>
          ...
          <div className='chapter-list'>
            {
              chapters.map((ele, i) => <ChapterCard name={ele.name} img={ele.img} content={ele.content} key={i} />)
            }
          </div>
        </div>
      </div>
